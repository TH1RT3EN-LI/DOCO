...
class JointStateStampFix(Node):
    ...
    def __init__(self) -> None:
        ...
        # ROS Topic /ugv/joint_states_raw 定义于 src/ugv_bringup/config/ros_gz_bridge.yaml，将 Gazebo 的 joint_state 先引流到 /ugv/joint_states_raw，经过该 node 清洗后发布到 /joint_states
        self.declare_parameter("input_topic", "/ugv/joint_states_raw")
        self.declare_parameter("output_topic", "/ugv/joint_states")
