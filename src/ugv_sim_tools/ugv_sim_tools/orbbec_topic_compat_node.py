...
class OrbbecTopicCompatNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("input_color_image_topic", "/ugv/camera_sim/color/image_raw")
        self.declare_parameter("input_color_info_topic", "/ugv/camera_sim/color/camera_info")
        self.declare_parameter("input_depth_image_topic", "/ugv/camera_sim/depth/image_raw")
        self.declare_parameter("input_depth_info_topic", "/ugv/camera_sim/depth/camera_info")
        self.declare_parameter("input_depth_points_topic", "/ugv/camera_sim/depth/points")

        self.declare_parameter("output_color_image_topic", "/ugv/camera/color/image_raw")
        self.declare_parameter("output_color_info_topic", "/ugv/camera/color/camera_info")
        self.declare_parameter("output_depth_image_topic", "/ugv/camera/depth/image_raw")
        self.declare_parameter("output_depth_info_topic", "/ugv/camera/depth/camera_info")
        self.declare_parameter("output_depth_points_topic", "/ugv/camera/depth/points")
        self.declare_parameter("output_ir_image_topic", "/ugv/camera/ir/image_raw")
        self.declare_parameter("output_ir_info_topic", "/ugv/camera/ir/camera_info")

        self.declare_parameter("color_frame_id", "ugv_camera_color_optical_frame")
        self.declare_parameter("depth_frame_id", "ugv_camera_depth_optical_frame")
        self.declare_parameter("ir_frame_id", "ugv_camera_ir_optical_frame")
        self.declare_parameter("cloud_frame_id", "ugv_camera_depth_optical_frame")
