...
class OdomToTfNode(Node):
    ...
    由于底盘驱动 ugv_base_driver 发布 /ugv/odom Topic, 但不广播 TF 变换(因为要用 EKF 融合里程和IMU数据)，而仿真中为了提高性能省去了 EKF 的环节；
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter("input_odom_topic", "/ugv/odom")
        self.declare_parameter("odom_frame_id", "ugv_odom")
        self.declare_parameter("child_frame_id", "ugv_base_footprint")
        # TF 频率和 /ugv/odom 频率解耦，提高性能
