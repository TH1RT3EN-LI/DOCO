...
class ClockGuard(Node):
    ...
    def __init__(self) -> None:
        super().__init__("ugv_clock_guard")
        # Shared sim clock bridge publishes /sim/clock_raw first, then this node
        # sanitizes it before exposing the canonical /clock topic.
