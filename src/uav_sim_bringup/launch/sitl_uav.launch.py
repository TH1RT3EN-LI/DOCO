...
DEFAULT_SIM_PX4_FRAME = "hw_uav"


def generate_launch_description():
    px4_frame = DEFAULT_SIM_PX4_FRAME
    frame_prefix = "uav_"
    ...
    sim_bringup_share = get_package_share_directory("uav_sim_bringup")
    description_share = get_package_share_directory("uav_description")
    pkg_prefix = get_package_prefix("uav_sim_bringup")
    script_path = os.path.join(pkg_prefix, "lib", "uav_sim_bringup", "run_px4_gz_uav.sh")
    ...
    default_rviz_config = os.path.join(sim_bringup_share, "config", "rviz", "sitl_uav.rviz")
    ...
    gz_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(sim_bringup_share, "launch", "gz_sim.launch.py")),
        launch_arguments={
            "world": world,
