...
def generate_launch_description():
    ...
    bridge_cfg = os.path.join(sim_bringup_share, "config", "ros_gz_bridge.yaml")
    foxglove_bridge_config_path = os.path.join(bringup_share, "config", "foxglove", "bridge.yaml")
    default_rviz_config = os.path.join(sim_bringup_share, "config", "rviz", "sim.rviz")
    ...
    scan_rewriter = Node(
        ...
        condition=IfCondition(rewrite_scan_frame),
    )
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("rewrite_scan_frame", default_value="false"),
