...
def generate_launch_description():
    ...
    ego_planner_node = Node(
        ...
        parameters=[
            {'fsm/flight_type': int_param(flight_type)},
            ...
            {'fsm/waypoint_num': int_param(point_num)},
            {'fsm/waypoint0_x': float_param(point0_x)},
            {'fsm/waypoint0_y': float_param(point0_y)},
            {'fsm/waypoint0_z': float_param(point0_z)},
            {'fsm/waypoint1_x': float_param(point1_x)},
            {'fsm/waypoint1_y': float_param(point1_y)},
            {'fsm/waypoint1_z': float_param(point1_z)},
            {'fsm/waypoint2_x': float_param(point2_x)},
            {'fsm/waypoint2_y': float_param(point2_y)},
            {'fsm/waypoint2_z': float_param(point2_z)},
            {'fsm/waypoint3_x': float_param(point3_x)},
            {'fsm/waypoint3_y': float_param(point3_y)},
            {'fsm/waypoint3_z': float_param(point3_z)},
            {'fsm/waypoint4_x': float_param(point4_x)},
            {'fsm/waypoint4_y': float_param(point4_y)},
            {'fsm/waypoint4_z': float_param(point4_z)},
            
            {'grid_map/resolution': 0.1},
            {'grid_map/map_size_x': float_param(map_size_x)},
            {'grid_map/map_size_y': float_param(map_size_y)},
            {'grid_map/map_size_z': float_param(map_size_z)},
            ...
            # camera parameter
            {'grid_map/cx': float_param(cx)},
            {'grid_map/cy': float_param(cy)},
            {'grid_map/fx': float_param(fx)},
            {'grid_map/fy': float_param(fy)},
            # depth filter
            ...
            # planner manager
            {'manager/max_vel': float_param(max_vel)},
            {'manager/max_acc': float_param(max_acc)},
            ...
            {'manager/use_distinctive_trajs': bool_param(use_distinctive_trajs)},
            {'manager/drone_id': int_param(drone_id)},
            ...
            {'optimization/max_vel': float_param(max_vel)},
            {'optimization/max_acc': float_param(max_acc)},

            # B-Spline parameters
            {'bspline/limit_vel': float_param(max_vel)},
            {'bspline/limit_acc': float_param(max_acc)},
            {'bspline/limit_ratio': 1.0},

            # Object prediction parameters
            {'prediction/obj_num': int_param(obj_num_set)},
